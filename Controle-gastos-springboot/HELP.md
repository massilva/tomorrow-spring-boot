...
* The original package name 'Controle-gastos.Controle-gastos-springboot' is invalid and this project uses 'Controle_gastos.Controle_gastos_springboot' instead.
